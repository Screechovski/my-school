...
export const EducatorInner = memo(({
    image,
    id,
    name,
    position,
...
export const EducatorInnerLoading = memo(() => {
    return (
        <article className={css.educatorInner}>
            <header className={css.educatorInner__header}>
                <div className={css.educatorInnerLoading__image + " loading"} />
                <div className={css.educatorInner__content}>
                    <div className={css.educatorInnerLoading__title + " loading"} />
                    <ul className={css.educatorInner__list}>
                        <li className={css.educatorInner__item}>
                            <h3>Должность: <span className={css.educatorInnerLoading__item + " loading"} /></h3>
                        </li>
                        <li className={css.educatorInner__item}>
                            <h3>Уровень образования: <span className={css.educatorInnerLoading__item + " loading"} /></h3>
                        </li>
                        <li className={css.educatorInner__item}>
                            <h3>Телефон: <span className={css.educatorInnerLoading__item + " loading"} /></h3>
                        </li>
                        <li className={css.educatorInner__item}>
                            <h3>E-mail: <span className={css.educatorInnerLoading__item + " loading"} /></h3>
                        </li>
                        <li className={css.educatorInner__item}>
                            <div className={css.educatorInnerLoading__text + " loading"} />
                        </li>
                    </ul>
                </div>
            </header>
