...
export const generatePosts = (count) => {
    ...
    for (let i = 0; i < count; i++) {
        posts.push({
            ...
            image: imgUrls[getRandomInt(imgUrls.length)],
            date: dates[getRandomInt(dates.length)],
            message: text[getRandomInt(text.length)]
        })
    }
